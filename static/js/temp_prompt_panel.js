/* temp_prompt_panel.js — Per-session Temporary Prompt UI
 *
 ...
 *
 * Depends on:  openOverlay / closeOverlay / toast  (modules/overlay.js)
...
window.tpClear  = tpClear;
window.tpUpdateCount = tpUpdateCount;
