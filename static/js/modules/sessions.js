...
(function () {
  ...
  const { appendMsg, sysMsg, clearMessages, updateTokenBar } = window.BAA.msg;
  ...
  async function submitRenameSession() {
    ...
    if (window.BAA.autosave) window.BAA.autosave.setLoadedName(d.name, renameTarget.filename);
    renameTarget = null;
    await loadSavedList();
  }
